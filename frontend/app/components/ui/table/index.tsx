...
export type ITableProps = React.ComponentProps<typeof ExpoTable>;
export type ITableHeaderProps = React.ComponentProps<typeof ExpoTHead>;
export type ITableBodyProps = React.ComponentProps<typeof ExpoTBody>;
export type ITableFooterProps = React.ComponentProps<typeof ExpoTFoot>;
export type ITableHeadProps = React.ComponentProps<typeof View | typeof Text> & {
	useRNView?: boolean;
};
export type ITableRowProps = React.ComponentProps<typeof ExpoTR>;
export type ITableDataProps = React.ComponentProps<typeof View | typeof Text> & {
	useRNView?: boolean;
};
export type ITableCaptionProps = React.ComponentProps<typeof ExpoTCaption>;
