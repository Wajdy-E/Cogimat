...
const actionsheetItemStyle = tva({
	base: "w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-500 active:bg-background-500 data-[focus=true]:bg-background-500 web:data-[focus-visible=true]:bg-background-500 data-[checked=true]:bg-background-500",
});
