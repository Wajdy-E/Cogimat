...
const selectTriggerStyle = tva({
	base: 'border border-secondary-0 rounded flex-row items-center overflow-hidden data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border-background-300',
	variants: {
		size: {
			xl: 'h-12',
			lg: 'h-11',
		...
		variant: {
			underlined:
				'border-0 border-b rounded-none data-[hover=true]:border-secondary-0 data-[focus=true]:border-secondary-0 data-[focus=true]:web:shadow-[inset_0_-1px_0_0] data-[focus=true]:web:shadow-secondary-0 data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700',
			outline:
