	...
	return (
		<ScrollView className="bg-background-700 p-5" contentContainerStyle={{ paddingBottom: 50 }}>
			<VStack space="3xl">
				...
				{notifications && (
					<VStack space="md">
						<Heading className="text-primary-500">{i18n.t("progress.weeklyGoal.title")}</Heading>
						<Divider className="bg-secondary-100" />
						<FormCheckboxGroup
							options={options}
							value={selectedDays}
						...
						<View className="flex justify-center items-center">
							<Heading className="self-start text-start">
								{i18n.t("progress.weeklyGoal.reminderTime")}
							</Heading>
							<DatePicker
								date={date}
						...
						<Button size="lg" variant="solid" action="primary" onPress={handleSave} disabled={isLoading}>
							<ButtonText>
								{isLoading ? i18n.t("general.loading") : i18n.t("progress.weeklyGoal.save")}
							</ButtonText>
